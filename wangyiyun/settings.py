...
DEFAULT_REQUEST_HEADERS = {
  ...
  'User-Agent':'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.104 Safari/537.36 Core/1.53.4482.400 QQBrowser/9.7.13001.400',
...
ITEM_PIPELINES = {
   'wangyiyun.pipelines.WangyiyunPipeline': 400,
   'wangyiyun.pipelines.Filte':300,
}
